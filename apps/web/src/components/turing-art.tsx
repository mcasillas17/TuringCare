...
import { type TuringPose, posePresentation } from "./turing/turing-poses";
...
export type TuringArtProps = {
  ...
  /** Whether the eyes are closed (blink). */
  eyesClosed: boolean;
};
