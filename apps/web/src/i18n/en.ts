export const en = {
  ...
  admin: {
    ...
    subtitle: "Understand activation, retention, and how owners get value from TuringCare.",
    dateRange: "Date range",
    lastDays: "Last {days}d",
    loading: "Loading insights…",
    loadError: "Failed to load insights.",
    totalUsers: "Total owners",
    newUsers: "New owners",
    wau: "Weekly active",
    ...
    step_first_goal: "Set a goal",
    step_first_practice: "Logged practice",
    step_brief_finalized: "Finalized a brief",
    step_brief_shared: "Shared a brief",
    completionTimes: "Happy-path completion time",
    completionTimesHelp: "Median, slow-tail, and seven-day completion for key owner journeys.",
    noCompletedJourneys: "No completed journeys in this cohort yet.",
    journey: "Journey",
    completed: "Completed",
    median: "Median",
    p90: "P90",
    within7Days: "Within 7d",
    ...
    featureAdoptionHelp: "Unique owners / successful actions, grouped into product areas.",
    noFeatureUsage: "No feature usage in this range.",
    feature_account: "Account",
    feature_briefs: "Briefs",
