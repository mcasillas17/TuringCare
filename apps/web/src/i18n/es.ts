...
export const es = {
  ...
  admin: {
    ...
    subtitle: "Entiende la activación, retención y cómo los dueños obtienen valor de TuringCare.",
    dateRange: "Rango de fechas",
    lastDays: "Últimos {days}d",
    loading: "Cargando información…",
    loadError: "No se pudo cargar la información.",
    totalUsers: "Total de dueños",
    newUsers: "Nuevos dueños",
    ...
    funnelHelp:
      "Dueños registrados en el rango seleccionado; cada paso debe seguir a su requisito previo.",
    step_signup: "Registro",
    step_first_dog: "Agregó un perro",
    step_first_journal: "Registró un momento",
    step_first_goal: "Definió un objetivo",
    step_first_practice: "Registró una práctica",
    ...
    featureAdoptionHelp: "Dueños únicos / acciones exitosas, agrupados por área de producto.",
    noFeatureUsage: "No hay uso de funciones en este rango.",
    feature_account: "Cuenta",
    feature_briefs: "Resúmenes",
