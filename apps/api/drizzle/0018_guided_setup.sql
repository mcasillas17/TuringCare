...
CREATE TABLE "guided_setups" (
	...
	CONSTRAINT "guided_setups_action_matches_intent" CHECK ("guided_setups"."first_action_type" IS NULL OR ("guided_setups"."intent" = 'understand_behavior' AND "guided_setups"."first_action_type" = 'behavior') OR ("guided_setups"."intent" = 'train_skill' AND "guided_setups"."first_action_type" = 'training') OR ("guided_setups"."intent" = 'track_progress' AND "guided_setups"."first_action_type" = 'progress')),
	CONSTRAINT "guided_setups_action_completion_consistent" CHECK (("guided_setups"."completed_at" IS NULL AND "guided_setups"."first_action_type" IS NULL AND "guided_setups"."first_action_id" IS NULL) OR ("guided_setups"."completed_at" IS NOT NULL AND "guided_setups"."completion_reason" = 'first_action_completed' AND "guided_setups"."current_step" = 'action' AND "guided_setups"."intent" IS NOT NULL AND "guided_setups"."first_action_type" IS NOT NULL AND "guided_setups"."first_action_id" IS NOT NULL) OR ("guided_setups"."completed_at" IS NOT NULL AND "guided_setups"."completion_reason" = 'skipped' AND "guided_setups"."current_step" = 'action' AND "guided_setups"."intent" IS NOT NULL AND "guided_setups"."first_action_type" IS NULL AND "guided_setups"."first_action_id" IS NULL) OR ("guided_setups"."completed_at" IS NOT NULL AND "guided_setups"."completion_reason" = 'abandoned' AND "guided_setups"."first_action_type" IS NULL AND "guided_setups"."first_action_id" IS NULL)),
