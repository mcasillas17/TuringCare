...
Events retain release/environment, fixed application/method/status metadata,
normalized route, request ID, generic exception classification, safe mechanism
metadata, source positions, and validated debug IDs. Source filenames are canonical
...
fields and inspect the serialized envelope, including real errors with linked causes.
...
The final line reports Node 22 and 13 locally received envelopes. Each child process
